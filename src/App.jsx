    ...
    <>
      ...
      <div className="w-full bg-zinc-900 py-32 text-white">
        <h1>
          ...
          debitis aut dignissimos facilis! Vel, culpa maxime temporibus
          doloribus eos minus, nulla exercitationem mollitia molestias amet
          reiciendis sapiente, quas consectetur voluptatibus quasi odio. Aperiam
          ad obcaecati praesentium, earum porro inventore?
        </h1>
      </div>
    </>
  );
